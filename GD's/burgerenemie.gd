...
func _ready():
	...
	notifier.screen_entered.connect(
		_on_screen_entered
	)
...
func _execute_attack():
	...
	var player_visual_offset = (
		player.visual_offset
	)
...
func take_damage(
	...
	var knockback = _calculate_knockback(
		amount,
		attack_type
	)

	var dir_x = sign(
		global_position.x - from_pos.x
	)
